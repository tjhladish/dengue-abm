...
Parameters* define_simulator_parameters(vector<long double> args, const unsigned long int rng_seed) {
    ...
    string imm_dir("/scratch/lfs/thladish/imm_thai");
    string sero_dir("/scratch/lfs/thladish/sero_thai");
    string mos_dir("/scratch/lfs/thladish/mos_thai");
    string mosloc_dir("/scratch/lfs/thladish/mosloc_thai");

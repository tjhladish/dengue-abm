...
matplot(t(medians[medians$vector_control==0,-tag_cols]/8.39660), type='l', lty=c(1,1,3,1), lwd=2, ylab='Annual incidence (cases per 100k)', col=c('black', 'green3',4,4), xlab='Year', main='Overall impact of vaccination on dengue cases (WHO assumptions -- 80% coverage)')
...
matplot(t(effect), type='l', lty=c(1,3,1), lwd=2, ylab='Annual effectiveness', col=c('green3',4,4), xlab='Year', main='Overall effectiveness of vaccination (WHO assumptions -- 80% coverage)')
...
matplot(t(cum_medians[cum_medians$vector_control==0,-tag_cols]/8.39660), type='l', lty=c(1,1,3,1), lwd=2, ylab='Cumulative incidence (cases per 100k)', col=c('black', 'green3',4,4), xlab='Year', main='Overall cumulative impact of vaccination (WHO assumptions -- 80% coverage)')
legend('bottomright',bty='n',legend = c('no vaccine','routine 9-year-old','routine 9yo + catchup to 17','routine 9yo + catchup to 30'), col=c(1,'green3',4,4), lty=c(1,1,3,1), lwd=2)
dev.off()
...
matplot(t(cum_effect[c(1,4,5),]), type='l', lty=1, lwd=c(2,2,3), ylab='Cumulative effectiveness', col=c(4,2,'purple'), xlab='Year', main='Overall cumulative effectiveness of vector control and routine vaccination ', ylim=c(0,1))
...
matplot(t(cum_effect[c(3,4,7),]), type='l', lty=1, lwd=c(2,2,3), ylab='Cumulative effectiveness', col=c(4,2,'purple'), xlab='Year', main='Overall cumulative effectiveness of vector control and routine vaccination + catchup', ylim=c(0,1))

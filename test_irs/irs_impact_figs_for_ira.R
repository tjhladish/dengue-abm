...
png('dengue_cases-cases-rerun10x.png', width=9, height=7, res=200, units='in')
...
matplot(t(cum_effect[c(1,3,4),]), type='l', lty=1, lwd=c(2,2,3), ylab='Cumulative effectiveness', col=c(4,2,'purple'), xlab='Year', main='Cumulative effectiveness of vector control and routine vaccination ', ylim=c(-0.25,1))
...
matplot(t(cum_effect[c(2,3,5),]), type='l', lty=1, lwd=c(2,2,3), ylab='Cumulative effectiveness', col=c(4,2,'purple'), xlab='Year', main='Cumulative effectiveness of vector control and routine vaccination + catchup', ylim=c(-0.25,1))

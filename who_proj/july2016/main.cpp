...
//0.868876936|4.0
    //const vector<float> foi_targets = {5.7, 7.8, 10.0, 13.5, 21}; // values used for plos med submission - try 1
    /* 0.0|0.06840428501
     * 1.0|0.265242958
     * 2.0|0.46176187
     * 3.0|0.69355033
    ...
    //const vector<float> foi_targets = {6.0, 8.2, 10.2, 14, 22}; // try 2
    /* 0.0|0.0864535353
     * 1.0|0.293016786
     * 2.0|0.48109981
     * 3.0|0.71420657
    ...
    //const vector<float> foi_targets = {6.2, 8.3, 10.4, 13.7, 21.7}; // try 3
    /* 0.0|0.1099872968
     * 1.0|0.317931059
     * 2.0|0.49915925
     * 3.0|0.7087432
